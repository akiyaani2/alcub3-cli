...
sys.path.append(os.path.join(project_root, '02-security-maestro'))

# Import shared components
from shared.classification import ClassificationLevel, SecurityClassification
...
class PatentInnovationTracker:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.classification_system = SecurityClassification("UNCLASSIFIED")
...
async def main():
    ...
    innovations = await tracker.analyze_directory("../../../02-security-maestro")
