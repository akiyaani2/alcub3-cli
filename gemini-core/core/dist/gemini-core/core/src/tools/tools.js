...
export class BaseTool {
     ...
     */
    constructor(name, displayName, description, parameterSchema, isOutputMarkdown = true, canUpdateOutput = false, summarizer = defaultSummarizer, shouldSummarizeDisplay = false) {
        this.name = name;
        ...
        this.shouldSummarizeDisplay = shouldSummarizeDisplay;
    }
    /**
