...
export declare abstract class BaseTool<TParams = unknown, TResult extends ToolResult = ToolResult> implements Tool<TParams, TResult> {
    ...
    readonly shouldSummarizeDisplay: boolean;
    /**
     ...
     */
    constructor(name: string, displayName: string, description: string, parameterSchema: Schema, isOutputMarkdown?: boolean, canUpdateOutput?: boolean, summarizer?: Summarizer, shouldSummarizeDisplay?: boolean);
    /**
