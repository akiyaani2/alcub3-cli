...
describe('JIT Privilege API', () => {
    ...
    describe('Cleanup', () => {
        it('should cleanup active processes on shutdown', () => {
            ...
            jitAPI.activeProcesses.set('req1', mockProcess1);
            jitAPI.activeProcesses.set('req2', mockProcess2);
            jitAPI.cleanup();
            expect(mockProcess1.kill).toHaveBeenCalled();
            expect(mockProcess2.kill).toHaveBeenCalled();
            expect(jitAPI.activeProcesses.size).toBe(0);
        });
    });
});
...
//# sourceMappingURL=jit_api.test.js.map